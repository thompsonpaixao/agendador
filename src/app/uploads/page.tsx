...
export default function UploadsPage() {
  const { accounts, profileMedia } = useAppState();
                ...
                <div className="p-3.5 flex-1 flex flex-col justify-between space-y-3">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400 mt-0.5">
                      Upload em {item.createdAt ? new Date(item.createdAt).toLocaleDateString("pt-BR") : "Recente"}
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    {item.deleteAfter && item.retentionStatus === "eligible_for_deletion" && (
                      <p className="text-[10px] text-slate-400">
                        Data prevista: {new Date(item.deleteAfter).toLocaleDateString("pt-BR")}
                      </p>
                    )}
                  </div>
