                  ...
                  <td className="px-4 py-3.5 text-right" onClick={(e) => e.stopPropagation()}>
                    {err.suggestedAction === "reconnect" ? (
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-semibold shadow-2xs transition-colors"
                      >
                        Reconectar conta
                      </button>
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg border border-slate-300 hover:bg-slate-100 text-slate-700 font-semibold transition-colors"
                      >
                        Resolver
                      </button>
                    )}
