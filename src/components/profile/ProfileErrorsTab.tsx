...
export function ProfileErrorsTab({ account, errors }: ProfileErrorsTabProps) {
  const { resolveError, retryError, reconnectAccount } = useAppState();
                    ...
                    <td className="px-4 py-3.5 text-right" onClick={(e) => e.stopPropagation()}>
                      {err.suggestedAction === "reconnect" ? (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-semibold shadow-2xs"
                        >
                          Reconectar
                        </button>
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-slate-900 hover:bg-slate-800 text-white font-semibold"
                        >
                          Reenviar
                        </button>
                      ) : (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg border border-slate-300 hover:bg-slate-100 text-slate-700 font-semibold"
                        >
                          Resolver
                        </button>
                      )}
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-lg w-full p-6 space-y-4 animate-in fade-in zoom-in-95">
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
              <button
                ...
                className="py-1.5 px-3 rounded-lg border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-semibold"
              >
              ...
              <button
                ...
                className="py-1.5 px-4 rounded-lg bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold"
              >
                Tentar novamente
              </button>
            </div>
