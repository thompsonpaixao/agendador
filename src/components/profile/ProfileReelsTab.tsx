                    ...
                    <div className="flex items-center justify-between pt-1 text-xs">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="py-1 px-2.5 rounded-lg border border-rose-200 bg-rose-50 hover:bg-rose-100 text-rose-700 text-xs font-semibold inline-flex items-center gap-1.5 cursor-pointer"
                          title="Excluir fila"
                        >
