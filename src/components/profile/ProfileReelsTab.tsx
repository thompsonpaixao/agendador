    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      {mediaToDelete && (
        <ConfirmDeleteModal
          ...
          title="Excluir Reel do Repositório"
          itemName={mediaToDelete.name}
          description="Tem certeza de que deseja excluir este vídeo do repositório? Se o vídeo estiver alocado em uma fila ativa ou agendamento futuro, a exclusão será bloqueada para evitar falhas de publicação."
          warningNote="O arquivo correspondente será eliminado do Supabase Storage e não poderá ser recuperado."
          confirmButtonText="Sim, excluir vídeo"
        />
      )}
