    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl flex items-start gap-3 text-xs text-slate-600">
        ...
        <div>
          ...
          <p className="mt-1 text-slate-500 leading-relaxed">
            Os arquivos deste perfil são armazenados em um bucket privado com isolamento rigoroso por conta.
            Mídias publicadas são mantidas por 7 dias de segurança após a confirmação oficial antes da limpeza automática. Mídias com erro de publicação permanecem preservadas para recuperação.
          </p>
        </div>
      </div>
      ...
      {mediaToDelete && (
        <ConfirmDeleteModal
          ...
          warningNote="O arquivo correspondente será eliminado do Supabase Storage e não poderá ser recuperado."
